...
#
# Host: 203.146.129.68 (MySQL 5.7.24)
# Database: frog_e_learning
# Generation Time: 2019-06-06 04:15:26 +0000
# ************************************************************
...
VALUES
	(1,1,NULL,NULL,NULL,'thailivestream','VRThebest@TH@','$2y$10$XU/3iAk9Wf5lKL5oV5KWgOsfUZLp7PgEkmEdaHlCRLwqxajbhP6ea','rLrr3Q7xfjKvfQOiEPpj1l3EbzOsaDAYACdBqGfOfiaXY84qiCSBAIujXHmp','Thailivestream','Admin','dev@dootvmedia.com','0873433362','02-412-8880, 090-986-1388','4/4 M.11 Ratchaphruek Rd.\nBangprom TalingChan\nBangkok 10170','64.png','JYoL5vh2cCxo4U7wGAbgY9QGvdhkyOWO4Rx2wo1T','2019-05-28 08:58:58',NULL,NULL,1,1,0,NULL,0,1,NULL,NULL,'2018-10-26 15:44:28',1),
	(2,1,NULL,NULL,NULL,'admin01','Admin#01','$2y$10$iJQBZViOzbRjL1UO2RTPW./bnR34R/XzKjvFlsXttRGuxTs9tVMte','kOQWfGh8cwdZ8TOeXOLePGJNpeVsfU4ZOJGiBtsAFBghfWHpYRNadQsNollq','Admin','01','dev@dootvmedia.com','0873433362',NULL,NULL,NULL,'osTvGLwqDsFwJL23ujZ6ocsCPMAQ1reR20tn5TYz','2019-05-13 14:48:59','2019-03-29 17:03:07',NULL,1,1,0,NULL,0,1,'2019-03-29 17:03:07',1,'2019-03-29 17:03:07',1);
...
VALUES
	(1,'Super Administrator',NULL,0,0,5,5,1,1,'2016-07-12 14:58:05','2019-05-24 13:53:24',1),
...
VALUES
	...
	(37,2,'Highlights','highlights','icon-fire',0,35,1,'2016-11-22 14:00:00','2016-11-22 14:00:00',1);
...
CREATE TABLE `bandwidths` (
  ...
  `disk_used_percent` float(5,2) DEFAULT NULL,
  `datetime` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `bandwidths` (`id`, `server_name`, `bandwidth_rx`, `bandwidth_tx`, `disk_used_percent`, `datetime`)
VALUES
	(1,'setlive-stream-cdn.open-cdn.com',0,0,NULL,'2019-03-12 13:38:39');
...
VALUES
	(1,'FrogGenius','แหล่งความรู้การเงินการลงทุนแบบดิจิทัล ผสมผสานเทคโนโลยีมัลติมีเดีย พร้อมบทเรียนที่เหมาะสำหรับนิสิต นักศึกษา และนักลงทุนที่ต้องการพัฒนาตนเองไปสู่นักลงทุนมืออาชีพแบบ Step by Step','elearning, ห้องเรียนนักลงทุน, เรียนรู้การลงทุน, เรียนรู้การเงิน','',0,'<h1 style=\"text-align: center;\">FROGGenius e-Learning</h1>\n\n<p>บริการเว็บไซต์ระบบ e-Learning ระดับประเทศ ด้วยฟังก์ชั่นที่ครบ จบ ในที่เดียว สามารถปรับแต่งให้เหมาะสมกับองค์กรหรือหน่วยงานต่างๆ ได้อย่างลงตัว ด้วยฟังก์ชั่นมากกว่า 80 ฟังก์ชั่น เพื่อตอบโจทย์ทุกความต้องการอย่างมีประสิทธิภาพ</p>\n','Frog Digital Group Co., Ltd.','612548896521','Contact Center','info@frogdigital.co','02-412-8880','FGN','4/4 หมู่ที่ 11 ถนนราชพฤกษ์ แขวงบางพรม เขตตลิ่งชัน กรุงเทพมหานคร 10170','https://www.facebook.com/FrogGenius/','https://www.facebook.com/FrogGenius/','','https://www.facebook.com/FrogGenius/','<p>สอบถามข้อมูลเพิ่มเติม กรุณาติดต่อ Contact Center โทร. <span class=\"text-white\">02-412-8880</span> อีเมล์: info@frogdigital.co</p>\n','2019-04-11 10:06:34','logo.png','220319110604-favicon.png',1,'','290319160458-default-share.jpg',1);
...
CREATE TABLE `courses` (
  ...
  `level_public` tinyint(1) NOT NULL DEFAULT '1',
